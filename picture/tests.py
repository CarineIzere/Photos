...
class MyGalery_TestCases(TestCase):
    def setUp(self):
        self.new_category = Category(cat_name='')
        self.new_category.save_category()
        self.new_location = Location(location_name = '')
        self.new_location.save_location()
        self.new_image = Image(id=1,image_name='learn', image_description='Learn 2019',image_path='media/gallery/dance-3134828_1920.jpg',image_category=self.new_category,image_location=self.new_location)
